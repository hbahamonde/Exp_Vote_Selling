...
In fact, except for a few ethnographic accounts, most researchers consider mostly party dynamics. Notably \parencite[55]{Auyero2000} analyzes the logic of clientelism in Argentina not only by looking at political brokers but also while paying particular attention to the ``clients' own views on the network.'' In turn, \textcite{Zarazaga2015a} interviews 120 brokers from Argentina, \textcite{Szwarcberg2012} explains that brokers are independent agents motivated by personal interests, while \textcite{Szwarcberg2013} argues that parties with access to resources is a necessary but insufficient condition to vote-buying. However, as \textcite[152]{Hagene2015} notes, many clientelist relationships are ``client-initiated.'' Notably \textcite[55-57]{Tosoni2007} explores different instances where slum dwellers strategically approach brokers to solve their collective needs, while \textcite{Gay1999} describes how neighborhood associations successfully managed to attract resources to Brazilian \emph{favelas} in exchange of electoral support (vote-selling).

% quant
In this paper we contend that omitting the voter's side complicates our understanding of the phenomenon as a whole. This issue is particularly problematic because there are just a few quantitative papers that address vote-selling. For instance, \cite{Hicken2015,Hicken2018} study vote-selling in the Philippines while \textcite{Bahamonde2020a} studies vote-selling in the U.S.\footnote{\textcite{Gonzalez-Ocantos2012,GonzalezOcantos2014,KiewietDeJonge2015} note that voters systematically lie when asked directly about vote-buying.} One particular consequence of this important deficit in the literature is that we do not know whether the dynamics of vote-selling and vote-buying are different. Specifically, one simple question that has not been addressed in the literature due to this deficit is \emph{Which setting (vote-buying or vote-selling) is more convenient for either side (parties and voters)?} 


This article starts by recreates the market conditions that make vote-buying and vote-selling more likely by randomizing 

 The authors are not aware of any experimental design that considers both vote-buying and vote-selling.\footnote{\textcite{Leight2020} present an experimental design of vote-buying. They find that vote-buying reduces the voters- willingness to hold politicians accountable.}
