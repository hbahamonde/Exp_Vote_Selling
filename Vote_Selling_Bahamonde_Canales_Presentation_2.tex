...
\begin{itemize}[<+->]
  ...
  \item Voters care about {\bf not losing the election} and also live on that space.\\
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
    ...
    \begin{itemize}
      ...
      \item When the party is winning but distant (voters exploit electorally strong parties' higher electoral stakes {\scriptsize\color{gray}$R_i$}.)
    \end{itemize}
